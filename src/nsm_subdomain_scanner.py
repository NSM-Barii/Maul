...
class Subdomain_Scanner():
    ...
    def _threader(cls, max_threads, url, domains, wordlist, CONSOLE=console, verbose=True):
        ...
        from concurrent.futures import wait, FIRST_COMPLETED  # ADDED: Import wait and FIRST_COMPLETED
        import itertools
        ...
        with ThreadPoolExecutor(max_workers=max_threads) as executor:
            ...
            try:
                ...
                if domains:
                    ...
                    task_iter = ((domain, sub, total) for domain in domains for sub in wordlist)
